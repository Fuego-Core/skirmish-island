    ...
    <Sheet open={open} onClose={onClose} title="MISSIONS" icon="laurier">
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        {visibleMissions.map((m) => (
          <div key={m.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10, padding: "11px 13px", background: C.inset, borderRadius: 9, border: `1px solid ${m.done ? C.gold : C.borderSoft}` }}>
